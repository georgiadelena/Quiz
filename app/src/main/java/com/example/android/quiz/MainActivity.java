...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculateScore(){
        ...
        //question 3 - you get 1 point when you pick all the right answers, otherwise it's a 0
        ...
        if(neverwhereBox.isChecked() && graveyardBox.isChecked() && oceanBox.isChecked() && !godsBox.isChecked() && !thingsBox.isChecked()){
            score++;
        }
        ...
        //question 6 - you get 1 point when you pick all the right answers, otherwise it's a 0
        ...
        if(salemsBox.isChecked() && petBox.isChecked() && standBox.isChecked() && !omensBox.isChecked() && !nightBox.isChecked()){
            score++;
        }
    ...
    public void showScore(View view) {
            ...
            Toast.makeText(this, "Hey " + name + "! " + getString(R.string.your_score)+ " " + score + ".", Toast.LENGTH_SHORT).show();
            score = 0;
    }
}